...
data9 = []
data10 = []
with open(r'/home/flash/pcm/data/Time/result_WLF.txt') as f:
    for line in f:
        fields = line.split()
...
with open(r'/home/flash/pcm/data/IPC/result_WLF.txt') as f:
    for line in f:
        fields = line.split()
        rowdata = map(float, fields)
...
with open(r'/home/flash/pcm/data/BR/result_WLF.txt') as f:
    for line in f:
        fields = line.split()
        rowdata = map(float, fields)
...
with open(r'/home/flash/pcm/data/BW/result_WLF.txt') as f:
    for line in f:
        fields = line.split()
        rowdata = map(float, fields)
...
with open(r'/home/flash/pcm/data/L2M/result_WLF.txt') as f:
    for line in f:
        fields = line.split()
        rowdata = map(float, fields)
...
with open(r'/home/flash/pcm/data/L3M/result_WLF.txt') as f:
    for line in f:
        fields = line.split()
        rowdata = map(float, fields)
...
with open(r'/home/flash/pcm/data/L2H/result_WLF.txt') as f:
    for line in f:
        fields = line.split()
        rowdata = map(float, fields)
...
with open(r'/home/flash/pcm/data/L3H/result_WLF.txt') as f:
    for line in f:
        fields = line.split()
        rowdata = map(float, fields)
...
with open(r'/home/flash/pcm/data/Cycles/result_WLF.txt') as f:
    for line in f:
        fields = line.split()
        rowdata = map(float, fields)
...
with open(r'/home/flash/pcm/data/CL3M/result_WLF.txt') as f:
    for line in f:
        fields = line.split()
        rowdata = map(float, fields)
...
with open(r'/home/flash/pcm/data/CL2M/result_WLF.txt') as f:
    for line in f:
        fields = line.split()
        rowdata = map(float, fields)
